...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        print(f'Out of these {q3.count()} shops currently {q4.count()} are active.\nWe will not notify the shops that are inactive assuming that they are already notified.')
        ...
        for a in q4.iterator():
            ...
            if consumtion_percentage > 50 and consumtion_percentage < 100 and a.a_notify_at_half != True and a.a_shop_id.a_online == True:
                ...
                print(f"message to client=> Hi, its {time} today. Your shop named {a.a_shop_id.a_name} having id {a.a_shop_id.a_id} has utilized {consumtion_percentage}% of budget allocated for this month. Your budget is set to {a.a_budget_amount} and you have currently used {a.a_amount_spent}. You will be notified again once your budget is fully exhaused.\n")
                ...
                print(f"Hi, its {time} today. Your shop named {a.a_shop_id.a_name} having id {a.a_shop_id.a_id} has utilized {consumtion_percentage}% of its allocated budget of this month. Your budget is set to {a.a_budget_amount} and you have currently used {a.a_amount_spent}. Your shop status will be set to offline.\n")
